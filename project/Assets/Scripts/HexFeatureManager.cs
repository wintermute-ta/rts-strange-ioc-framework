...
public class HexFeatureManager : MonoBehaviour {
	...
	public void AddWall (
		EdgeVertices near, HexMapCell nearCell,
		EdgeVertices far, HexMapCell farCell,
	...
	public void AddWall (
		Vector3 c1, HexMapCell cell1,
		Vector3 c2, HexMapCell cell2,
		Vector3 c3, HexMapCell cell3
	) {
		if (cell1.Walled) {
			if (cell2.Walled) {
				if (!cell3.Walled) {
	...
	void AddWallSegment (
		Vector3 pivot, HexMapCell pivotCell,
