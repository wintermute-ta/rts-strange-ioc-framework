...
namespace Views
{
    namespace HexGrid
    {
        public class HexFeatureManager : MonoBehaviour
        {
            ...
            public void AddFeature(HexMapCell cell, Vector3 position)
            {
                if (cell.IsSpecial)
                {
                    return;
            ...
            public void AddSpecialFeature(HexMapCell cell, Vector3 position)
            {
                HexHash hash = HexMetrics.SampleHashGrid(position);
            ...
            public void AddWall(EdgeVertices near, HexMapCell nearCell, EdgeVertices far, HexMapCell farCell, bool hasRiver, bool hasRoad)
            {
            ...
            public void AddWall(Vector3 c1, HexMapCell cell1, Vector3 c2, HexMapCell cell2, Vector3 c3, HexMapCell cell3)
            {
                if (cell1.Walled)
                {
                    if (cell2.Walled)
            ...
            void AddWallSegment(Vector3 pivot, HexMapCell pivotCell, Vector3 left, HexMapCell leftCell, Vector3 right, HexMapCell rightCell)
            {
