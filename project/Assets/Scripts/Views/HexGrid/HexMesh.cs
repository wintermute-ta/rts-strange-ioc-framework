    ...
    namespace HexGrid
    {
        ...
        public class HexMesh : MonoBehaviour
        {
            ...
            public void Apply()
            {
                ...
                if (material != null)
                {
                    material.SetFloat("_CellPerturbStrength", HexMetrics.cellPerturbStrength);
                }
            }
            ...
            public void SetHighlightCoord(HexCoordinates coordinates, float value)
            {
                if (material != null)
                {
                    material.SetVector("_Point", new Vector4(coordinates.X, coordinates.Y, coordinates.Z, value));
                }
            }
        }
    }
