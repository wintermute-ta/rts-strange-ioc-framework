...
public class HexMapEditorMediator : Mediator
{
    ...
    [Inject]
    public CameraValidatePositionSignal OnValidatePosition { get; private set; }
    [Inject]
    public LockMapCameraSignal OnLockMapCamera { get; private set; }
    [Inject]
    ...
    {
        OnLockMapCamera.Dispatch(true);
    }

    private void OnClosePopup()
    {
        OnLockMapCamera.Dispatch(false);
    }
    ...
    {
        HexGridChangeUIVisible.Dispatch(visible);
    }
}
